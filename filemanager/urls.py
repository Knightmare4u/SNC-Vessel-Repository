...
urlpatterns = [
    ...
    path(
        'logout/',
        auth_views.LogoutView.as_view(template_name='filemanager/logout.html'),
        name='logout',
    ),
    ...
    path(
        'upload/progress/<str:session_id>/',
    ...
    path(
        'admin/folder-browser/', views.admin_folder_browser, name='admin_folder_browser'
    ),
